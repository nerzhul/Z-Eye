<?php
	...
	*/
	...
	final class rSnortMgmt extends FSRules {
		function __construct($locales) { parent::__construct($locales); }

		public function showMgmtInterface($activerules = array()) {
			$output = FS::$iMgr->ruleLines(_("menu-title"),$activerules,array(
				array(_("rule-read-datas"),		"mrule_snortmgmt_read"),
				array(_("rule-write-datas"),	"mrule_snortmgmt_write")
			));
			return $output;
		}
		...
		public function canAccessToModule() {
			...
			if(FS::$sessMgr->hasRight("read","snortmgmt")) {
				return true;
			}
