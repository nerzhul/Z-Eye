		...
		function __construct() {
			...
			$locales = array(
				"fr" => array(
					...
					"base-dn" => "Base DN",
					"confirm-removedirectory" => "Êtes vous sûr de vouloir supprimer l'annuaire '%s' ?",
					"confirm-removeuser" => "Êtes vous sûr de vouloir supprimer l'utilisateur '%s' ?",
					"Directory" => "Annuaire",
					"Editing" => "Edition...",
				...
				"en" => array(
					...
					"base-dn" => "Base DN",
					"confirm-removedirectory" => "Are you sure to want to remove directory '%s' ?",
					"confirm-removeuser" => "Are you sure to want to remove user '%s' ?",
					"Directory" => "Directory",
					"Editing" => "Editing...",
