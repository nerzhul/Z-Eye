		...
		function __construct() {
			...
			$locales = array(
				"fr" => array(
					...
					"Model" => "Modèle",
					"Modify-IPM-Infos" => "Modifier les informations DHCP",
					...
					"title-dhcp-distrib" => "Cache de collecte DHCP",
				...
				"en" => array(
					...
					"menu-title" => "Search",
					"Model" => "Model",
					"Modify-IPM-Infos" => "Modifier IPM informations",
					...
					"title-dhcp-distrib" => "DHCP collect cache",
