<?php
	...
	*/
	...
	final class lMaps extends FSLocales {
		function __construct() {
			...
			$locales = array(
				"fr" => array(
					...
					"err-no-node-found" => "Aucun noeud trouvé",
					...
					"Import" => "Importer",
					"Import-Nodes" => "Importer les noeuds (Réseau & Icinga)",
				...
				"en" => array(
					...
					"err-no-node-found" => "No node found",
					"err-no-tab" => "Bad tab",
					...
					"Import" => "Import",
					"Import-Nodes" => "Import nodes (network & Icinga)",
