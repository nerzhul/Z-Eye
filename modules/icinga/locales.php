		...
		function __construct() {
			...
			$locales = array(
				"fr" => array(
					...
					"confirm-remove-notif-strategy" => "Êtes vous sûr de vouloir supprimer la stratégie de notification ",
				...
				"en" => array(
					...
					"confirm-remove-notif-strategy" => "Are you sure you want to remove notification strategy ",
