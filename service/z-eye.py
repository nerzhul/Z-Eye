...
class ZEyeDaemon(Daemon.Daemon):
	def run(self):
		...
		ZEyePeriodicCmd(15*60,15,"Netdisco device discovery","/usr/bin/perl /usr/local/bin/netdisco -C /usr/local/etc/netdisco/netdisco.conf -R").start()
		ZEyePeriodicCmd(5*60,60,"Netdisco device MAC walk","/usr/bin/perl /usr/local/bin/netdisco -C /usr/local/etc/netdisco/netdisco.conf -m").start()
		ZEyePeriodicCmd(5*60,90,"Netdisco device ARP walk","/usr/bin/perl /usr/local/bin/netdisco -C /usr/local/etc/netdisco/netdisco.conf -a").start()
		ZEyePeriodicCmd(15*60,1200,"Netdisco device netbios walk","/usr/bin/perl /usr/local/bin/netdisco -C /usr/local/etc/netdisco/netdisco.conf -w").start()
